        ...
        <div className="cta-box">
          <div className="cta-layout">
            <div className="cta-l">
              ...
              <h2>Pronto para modernizar seu negócio?</h2>
              <p>Converse com nossa equipe e descubra como o passaporte veicular digital transforma sua operação.</p>
              <div className="cta-btns">
                ...
                <a href="#" className="btn-g">Baixar apresentação</a>
              </div>
            </div>
